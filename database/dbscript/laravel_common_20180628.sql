...
INSERT INTO `dev_modules` VALUES (1,'auth','auth',1,0),(2,'acl','acl',2,0),(3,'api','api',3,0),(4,'web','web',4,0),(5,'dev','dev',5,1);
...
BEGIN
    ...
    IF NOT EXISTS(SELECT id FROM dev_translation 
...
-- Dump completed on 2018-07-02 11:59:28
